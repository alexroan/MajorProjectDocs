...
\begin{description}
\item[Instanciate] Instanciating the object and set the attributes to desired values
\item[Create()] Use the atribute values to insert a new record into the database table via the 'Create()' method in the class.
...
\section{Website Testing}
	\subsection{Overview}
		The website testing was performed by following the fnctional requirements set out in the project specification document compiled at the beginning of the project. The full feature test results table can be found in the appendix.
